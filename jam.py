...
os.system('git pull')
os.system('clear')
logo = ('\x1b[1;96m    .S   .S_SSSs     .S_SsS_S.   \n\x1b[1;96m   .SS  .SS~SSSSS   .SS~S*S~SS.  \n\x1b[1;96m   S%S  S%S   SSSS  S%S  Y S%S  \n\x1b[1;96m   S%S  S%S    S%S  S%S  •  S%S  \n\x1b[1;96m   S&S  S%S•SSSS%S  S%S  •  S%S  \n\x1b[1;96m   S&S  S&S  SSS%S  S&S  °  S&S  \n\x1b[1;96m   S&S  S&S    S&S  S&S     S&S  \n\x1b[1;96m   S&S  S&S    S&S  S&S     S&S  \n\x1b[1;96m   d*S  S*S    S&S  S*S     S*S  \n\x1b[1;96m  .S*S  S*S    S*S  S*S     S*S  \n\x1b[1;96msdSSS   S*S    S*S  S*S     S*S  \n\x1b[1;96mYSSY    SSS    S*S  SSS     S*S  \n\x1b[1;96m               SP           SP   \n\x1b[1;96m               Y            Y [+923053176060]\n\x1b[1;97m-----------------------------------------------\n\x1b[1;91m➣ Author : Jam Shahrukh x Xtylo Ali Raza\n\x1b[1;91m➣ Github : https://github.com/Blacklisted\n\x1b[1;91m➣ Fb Page : https://m.facebook.com/Jam Shahrukh Official\n\x1b[1;92m➣ Ref By : (Stylish Queen x Muskan Noor x Zahra Zohaib)\n\x1b[1;92m➣ Ref By : (Ahmed Gondal x Kashi Gujjar x Janzada Khan) \n\x1b[1;97m-----------------------------------------------')  
def reg():
    os.system('clear')
    print logo
    print ''
...
def a_s():
    ...
    if a_s == '1':
        ...
        print ''
        print '\033[1;93mexample: 123,1234,&,789789,223344'
        print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                print '\x1b[1;97m[JAM-CP] ' + uid + ' | ' + pass1
                ...
                if 'loc' in q:
                    ...
                    print '\x1b[1;97m[JAM-CP] ' + uid + ' | ' + pass2
                    cp = open('HOP_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    if 'loc' in q:
                        ...
                        print '\x1b[1;97m[JAM-CP] ' + uid + ' | ' + pass3
                        cp = open('HOP_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        if 'loc' in q:
                            ...
                            print '\x1b[1;97m[JAM-CP] ' + uid + ' | ' + pass4
                            cp = open('HOP_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'loc' in q:
                                ...
                                print '\x1b[1;97m[JAM-CP] ' + uid + ' | ' + pass5
                                cp = open('HOP_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                if 'loc' in q:
                                    ...
                                    print '\x1b[1;97m[JAM-CP] ' + uid + ' | ' + pass6
                                    cp = open('HOP_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    if 'loc' in q:
                                        ...
                                        print '\x1b[1;97m[JAM-CP] ' + uid + ' | ' + pass7
                                        cp = open('HOP_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        if 'loc' in q:
                                            ...
                                            print '\x1b[1;97m[JAM-CP] ' + uid + ' | ' + pass8
                                            cp = open('HOP_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
                                            ...
                                            if 'loc' in q:
                                                ...
                                                print '\x1b[1;97m[JAM-CP] ' + uid + ' | ' + pass9
                                                cp = open('HOP_CP.txt', 'a')
                                                cp.write(uid + ' | ' + pass9 + '\n')
                                                cp.close()
                                                ...
                                                if 'loc' in q:
                                                    ...
                                                    print '\x1b[1;97m[JAM-CP] ' + uid + ' | ' + pass10
                                                    cp = open('HOP_CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass10 + '\n')
                                                    cp.close()
    ...
    print ''
    print 47 * '-'
    print ' \033[1;92mThanks Bol Do Kamino'
